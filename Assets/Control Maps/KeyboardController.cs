// GENERATED AUTOMATICALLY FROM 'Assets/Control Maps/KeyboardController.inputactions'
...
public class @KeyboardController : IInputActionCollection, IDisposable
{
    ...
    public struct PlayerActions
    {
        ...
        public PlayerActions(@KeyboardController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @KeyboardController m_Wrapper;
        public GameStateActions(@KeyboardController wrapper) { m_Wrapper = wrapper; }
